...
namespace Cortex.Types
{
    ...
    public readonly struct AnyOf<T1, T2, T3> : IEquatable<AnyOf<T1, T2, T3>>, IAnyOf
    {
        ...
        public TResult Match<TResult>(
            ...
            Func<T3, TResult> t3Handler) => _typeIndices.Contains(0) && _value is T1 t1
            ? t1Handler(t1)
        ...
        public override bool Equals(object obj) =>
            obj is AnyOf<T1, T2, T3> other && Equals(other);
